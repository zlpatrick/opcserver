...
namespace OPCServerProject
{
    ...
    {
        //
        // Refer to WtOPCsvrAPI.h for description of each interface
        //
        ...
        //       [DllImport("WtOPCsvr.dll")]
        //       public static extern bool  SetServerState( OPCSERVERSTATE ServerState );
        ...
        public delegate void DeviceReadDelegate(UInt32 hItem, ref Object Value, ref UInt16 Quality, ref FILETIME Timestamp);
        [DllImport("WtOPCsvr.dll")]
